...
/* ─────────────────────────────────────────
   ...
   its own validation & touched state
───────────────────────────────────────── */
  ...
  return (
    <div className="relative pt-5 pb-1">
      ...
      <div className="relative">
        ...
        {/* {value && touched && (
          <span
            className="absolute right-0 top-1/2 -translate-y-1/2 text-[15px]"
            style={{ color: showError ? "#ef4444" : "#22c55e" }}
          >
            {showError ? "✕" : "✓"}
          </span>
        )} */}
      ...
      // )} */}
      {/* {showSuccess && (
        <p className="text-[11px] text-green-500 mt-1" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          Looks good!
        </p>
      )} */}
    </div>
...
/* ─────────────────────────────────────────
   Password rule checker row
───────────────────────────────────────── */
// const PasswordRule = ({ rule, met }) => (
//   <div className="flex items-center gap-2 mb-1">
//     <span className="text-[11px] font-bold" style={{ color: met ? "#8C5A3C" : "#c9a07a" }}>
//       {met ? "✓" : "·"}
//     </span>
          ...
          >
            ...
            {success ? (
              ...
              <>
                ...
                <div className="fu0">
                  <p
                    className="text-[10px] tracking-[0.22em] uppercase font-bold mb-2.5"
                    style={{ color: "#C08552" }}
                  >
                    ...
                    <div className="slide-in">
                      ...
                      >
                        ...
                        {passwordRules.map(({ rule, met }) => (
                          <PasswordRule key={rule} rule={rule} met={met} />
                        ))}
                      </div>
                    </div>
                  )}
